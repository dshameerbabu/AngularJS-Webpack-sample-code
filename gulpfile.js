...
var copyAllFiles = {
    ...
    wegAppPartials: {
      src : 'src/weg/partial/**/*',
      dest: buildPath + '/src/weg/partial/'
    },
...
gulp.task('scripts', function () {
    ...
    return streamqueue({objectMode: true},
        ...
        gulp.src("./src/eventPanel/directive/displayTimeDirective.js"),
        gulp.src("./src/eventPanel/factory/eventFactory.js"),
        gulp.src("./src/weg/service/eventInfoService.js"),
        gulp.src("./src/weg/controller/wegController.js"),
        // Weg integration
...
gulp.task('styles', ['scripts'], function () {
    return streamqueue({objectMode: true},
        ...
        gulp.src("./src/styles/displayTime.css"),
        gulp.src("./css/weg-panel.css"),
        gulp.src("./src/eventPanel/styles/eventPanelChanges.css")
        // Weg integration
    )
    .pipe(debug())
